/**
 * @source https://docs.google.com/presentation/d/1QjAs-zx1i0_XWlLqsKtexb-iueao9jNLkN-gW9QxAD0/edit#slide=id.g3655bd8207_0_26
 */
...
public class QuickSort {
    ...
    private static <Item extends Comparable> void show(Queue<Item> items) {
        for (Item item : items) {
            StdOut.println(item);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        show(QuickSort.quickSort(queue));
    }
